        ...
        <div className="flex flex-col items-center justify-center w-full h-full bg-orange-400 text-white font-bold font-cursive text-2xl">
            <div className="justify-items-center p-4">
                ...
                <div className="mt-8 text-black"> 
                    <p className="text-3xl font-quicksand text-center font-bold">Contactanos</p>
                    <p className="text-1xl font-quicksand"> Sigue disfrutando en nuestras redes sociales </p>
