            ...
            <div className="w-full h-full flex flex-col items-center space-y-8 bg-gradient-to-r from-black via-black to-orange-400">
                ...
                <div className="w-full p-4 grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div className="flex flex-col mt-4 w-full items-center space-y-2">
                        <p className="text-5xl font-bold font-cursive text-white text-start">Hot Dog <span className="text-danger">[clásica]</span></p>
                        <p className="text-3xl font-bold font-quicksand text-white text-center">Salchicha, Vegetales, Mayonesa, Cat sup, Mostaza</p>
                        <CardProduct image={HotDog} title="3 por " price={40} height={350} width={400} />
                    </div>
                    <div className="flex flex-col mt-4 w-full items-center space-y-2">
                        ...
                        <CardProduct image={HotDog} title="3 por " price={60} height={350} width={400} />
                    </div>
                </div>
