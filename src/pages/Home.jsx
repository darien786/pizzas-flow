...
export default function Home(){
    ...
    return(
        <div className="flex flex-col h-full w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 bg-gradient-to-r from-orange-400 via-black via-50% to-orange-400 w-full h-full rounded-lg p-4 space-y-4 mt-6">
                    <div className="flex flex-col justify-center items-center text-white">
                        <p className="text-4xl font-bold mb-2">Pizzas</p>
                        <CardProduct image={Pizza} title="Pizza" price={95} />
                    </div>
                    <div className="flex flex-col justify-center items-center text-white">
                        <p className="text-4xl font-bold mb-2">Hamburguesas</p>
                        <CardProduct image={Hamburguesa} title="Hamburguesa" price={45} />
                    </div>
                    <div className="flex flex-col justify-center items-center text-white">
                        <p className="text-4xl font-bold mb-2">Hot Dogs</p>
                        <CardProduct image={HotDog} title="Hot Dog" price={15} />
                    </div>
                </div>
        </div>
    )
